...
<img src="images/search.png" alt=""></button>
				...
				<div class="wishlist_count" id="h"><?php if(isset($_SESSION['wishrow'])){ echo $_SESSION['wishrow'];}else {echo '0';}?></div>
								</div>
							</div>
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							...
							<?php 
							$a=mysqli_query($conn,"select * from product ");
						...
						<?php
							$q3=mysqli_query($conn,"select * from product ");
							...
							<div class="product_item is_new">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<?php echo $row3['p_img'];?>" alt=""></div>
								<div class="product_content">
									<div class="product_price">&#x20B9 <?php echo $row3['p_price'];?></div>
									<div class="product_name"><div><a href="des.php?id=<?php echo $row3['p_id']; ?>" tabindex="0"><?php echo $row3['p_name'];?></a></div></div>
								</div>
														</div>
							<?php } ?>
						</div>
