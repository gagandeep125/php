...
{
	$name =  $_REQUEST['name'];
	$wish = unserialize(serialize($_SESSION['wish']));
	for($i=0;$i<count($wish);$i++)
	{
		if ($name == $wish[$i]->pro_name)
		{ 
			//echo "<br>done";
			unset($_SESSION['wish'][$i]);
			//echo "k";
		}
	}
}
	...
	<header class="header">
		...
		<div class="header_main">
			<div class="container">
				...
				<div class="wishlist_count"><?php if($_SESSION['wishrow']!=0){ echo $_SESSION['wishrow'];}else {echo '0';}?></div>
								</div>
							</div>
						...
						<?php
							...
							<ul class="cart_list">
								<li class="cart_item clearfix">
									<div class="cart_item_image"><img src="<?php echo $wish[$i]->pro_image; ?>" alt=""></div>
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
									
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Name</div>
											<div class="cart_item_text"><?php echo $wish[$i]->pro_name; ?></div>
										</div>
									
										<div class="cart_item_price cart_info_col">
											<div class="cart_item_title">Price</div>
											<div class="cart_item_text"><?php echo $wish[$i]->pro_price; ?></div>
										</div>
									
										<div class="cart_item_total cart_info_col">
											<div class="cart_item_title">Delete</div>
											<div class="cart_item_text">
			<a href="wish.php?name=<?php echo $wish[$i]->pro_name; ?>&action=delete" onclick="confirm('Are U Sure ?')">Remove </a></div>
										</div>
									</div>
								</li>
							</ul>
